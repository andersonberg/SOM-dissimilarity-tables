...
void IntervalValued::setCidade(std::string _cidade)
{
	cidade = _cidade;
}

std::string IntervalValued::getCidade()
{
	return cidade;
}

void IntervalValued::setPais(std::string _pais)
{
	pais = _pais;
}

std::string IntervalValued::getPais()
{
	return pais;
}
