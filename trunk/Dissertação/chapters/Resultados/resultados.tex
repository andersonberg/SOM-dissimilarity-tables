...
A tabela \ref{iris_index} mostra os valores para os índices de Rand corrigido, F-measure e a Taxa de Erro Global de Classificação (OERC). Em cada linha dessa tabela, pode-se observar os valores dos índices para cada um dos diferentes valores de $T_{max}$.
